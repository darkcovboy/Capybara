...
[CustomEditor(typeof(LuckyWheel))]
public class LuckyWheelEditor : UnityEditor.Editor
{
    private LuckyWheel _target;
    ...
    private SerializedProperty _audioOpen;
    ...
    private void AssignVariables() {
        ...
        _audioOpen = _serializedObject.FindProperty("_audioOpen");
    ...
    public override void OnInspectorGUI() {
        ...
        if (_showCommunications) {
            ...
            EditorGUILayout.PropertyField(_audioOpen, true);
