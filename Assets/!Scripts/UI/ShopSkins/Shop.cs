...
namespace UI.ShopSkins
{
    public class Shop : Screen
    {
        ...
        [Inject]
        public void Constructor(MoneyCounter moneyCounter, SaveManager saveManager, ScreensHolder screensHolder)
        {
        ...
        private void OnItemViewClicked(SkinView item)
        {
            ...
            _skinPlacement.InstantiateModel(item.Stars, item.ModelName, item.ViewModel);
        ...
        private void OnAdButtonClick()
        {
            void CheckAd()
            {
                ...
                if (_saveManager.PlayerData.AdViewsForSkins[_previousSkinView.CharacterSkinItem.CharacterType] !=
                    _previousSkinView.CharacterSkinItem.AmountOfAds) return;
                _shopPanel.OpenSkin(_previousSkinView);
                SelectSkin();
                _previousSkinView.Unlock();
            }
        ...
        private void CloseShop()
        {
            ...
            _screensHolder.OpenScreen(ScreenType.Start);
        }
